...
def read_qr_code(frame):
    ...
    if decoded_objects:
        ...
        # Mapping orientations to corresponding letters
        orientation_mapping = {
            'up': 'A',
            'right': 'B',
            'down': 'C',
        ...
        # Convert orientation to the desired letter
        letter_orientation = orientation_mapping.get(orientation, orientation)
...
# Function to continuously scan QR codes from webcam and yield updates
def continuous_qr_code_scan():
    ...
    while True:
        ...
        if qr_code_data:
            ...
            if scanned_count == 2:
                yield qr_code_dict  # Send the entire dictionary as an update
                break
